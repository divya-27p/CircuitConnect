...
function Navbar() {
  ...
  return (
    <NavContainer>
      <Link to="/">
        <NavLogo>
          <NavImage src="/circuitconnect.png" alt="brand=logo" />
          <NavBrand>CircuitConnect</NavBrand>
          {show && onlineUsers && <NavCount> Engineers Online: {onlineUsers.length || 0}</NavCount>}
        </NavLogo>
      </Link>
      {user ? (
        <NavUser>
